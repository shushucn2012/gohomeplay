...
public class TaskChooseLevelPopWin extends PopupWindow {
    private Context mContext;
    private View toolView, area_bottom_finish;
    private ListView lv_teachers;
    private LevelListAdapter listAdapter;
    private List<TaskLevelBean> dataList;

    public TaskChooseLevelPopWin(Context context, List<TaskLevelBean> _list) {
        super(context);
        mContext = context;
        this.dataList = _list;
...
//		lv_teachers.setOnItemClickListener(itemClickListener);
    ...
    public class LevelListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            TaskLevelBean item = dataList.get(position);
