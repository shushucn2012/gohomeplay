...
public class DoneWorkRvAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public DoneWorkRvAdapter(Context context, List<WorkMonthBean> list) {
    ...
    class WorkOfMonthListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                holder.img_leftmsg.setVisibility(View.GONE);
