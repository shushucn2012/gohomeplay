...
import com.park61.teacherhelper.module.my.LibraryDetailActivity;
import com.park61.teacherhelper.module.my.adapter.MyLibAdapter;
...
public class FragmentMyLib extends BaseFragment {

    FragmentMyActivityBinding binding;
    MyLibAdapter dataAdapter;
    ...
    public void initData() {
        list = new ArrayList<>();
        dataAdapter = new MyLibAdapter(parentActivity, list);
        ...
        adapter.setOnItemClickListener((view, position)->{
            Intent it = new Intent(parentActivity, LibraryDetailActivity.class);
    ...
    private void asyncGetMyActivity(){
        //我的活动列表
        String url = AppUrl.host + AppUrl.myActivityLib;
