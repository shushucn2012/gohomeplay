...
public class InterestingClassActApplyListActivity extends BaseActivity{
    ...
    private List<InterestingCourseBean> dataList;
    private InterestingCrouseListAdapter adapter;
    private int activityId;

    @Override
    public void setLayout() {
        setContentView(R.layout.activity_interestingclassact_applylist);
    }
    ...
    public void initView() {
        ...
        adapter = new InterestingCrouseListAdapter(mContext, dataList, InterestingCrouseListAdapter.FROM_PAGE.APPLYLIST_PAGE);
    ...
    private void asyncDataList() {
        String wholeUrl = AppUrl.host + AppUrl.interestClassApplyData;
    ...
    BaseRequestListener listener = new JsonRequestListener() {
        ...
        public void onSuccess(int requestId, String url, JSONObject jsonResult) {
            plv_interesting_class.onRefreshComplete();
            ArrayList<InterestingCourseBean> currentPageList = new ArrayList<>();
            ...
            for (int i = 0; i < actJay.length(); i++) {
                InterestingCourseBean bean = gson.fromJson(actJay.optJSONObject(i).toString(), InterestingCourseBean.class);
                bean.setActId(activityId);
                currentPageList.add(bean);
            }
