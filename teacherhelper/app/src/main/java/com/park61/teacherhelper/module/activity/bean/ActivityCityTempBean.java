...
public class ActivityCityTempBean implements Serializable {

    private String moduleName;
    private  String templeteCode;
    private List <ActivityCityListBean>templeteData;

    public List<ActivityCityListBean> getTempleteData() {
        return templeteData;
    }
    ...
    public void setTempleteData(List<ActivityCityListBean> templeteData) {
