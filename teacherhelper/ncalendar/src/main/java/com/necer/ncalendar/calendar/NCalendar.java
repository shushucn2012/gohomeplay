...
//        if(listener !=null) listener.listTop(childViewTop);
        //4种情况
    ...
    private void autoScroll(int startMonth, int endMonth, int startChild, int endChild) {
        ...
        monthValueAnimator.setDuration(500);
        monthValueAnimator.start();

        childViewValueAnimator.setIntValues(startChild, endChild);
//        childViewValueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
//            @Override
//            public void onAnimationUpdate(ValueAnimator animation) {
//                Object o = animation.getAnimatedValue();
//                if(listener !=null) listener.listTop((int)o);
//            }
//        });
        childViewValueAnimator.setDuration(500);
    ...
    public void setScrollListener(CalendarScrollListener l){
        listener = l;
    }
