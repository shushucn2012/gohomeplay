...
/**
 * 培训活动免费内容网页展示页, 回退按钮可以回退h5页面
 */
public class FreeContentWebViewActivity extends BaseActivity {
    ...
    public void initData() {
        payst = getIntent().getIntExtra("payst", -1);
        activityId = getIntent().getIntExtra("activityId", -1);
        //关闭顶部右侧按钮
        String title = getIntent().getStringExtra("PAGE_TITLE");

        String url = getIntent().getStringExtra("url");
        url_share = "http://m.61park.cn/t/html-sui/activity/activity-index.html?activityId=" + activityId;
        if (payst == 0) {//免费
//            url = "http://t.61park.cn/html-sui/activity/activity-list.html?payst=" + payst + "&activityId=" + activityId;
            url = "http://m.61park.cn/t/html-sui/activity/activity-list.html?payst=" + payst + "&activityId=" + activityId;

            if (!TextUtils.isEmpty(title)) {
                tv_page_title.setText("试看《" + title + "》");
            }
        } else {//付费
//            url = "http://t.61park.cn/html-sui/activity/activity-nofreelist.html?activityId=" + activityId;
            url = "http://m.61park.cn/t/html-sui/activity/activity-nofreelist.html?activityId=" + activityId;
        ...
        syncCookie(url);
        wv.loadUrl(url);
        mShareInfoBean = new ShareInfoBean(url_share, getIntent().getStringExtra("picUrl"), title, getIntent().getStringExtra("intro"));
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        } else if (requestCode == FOR_ASK) {
//            String url = "http://t.61park.cn/html-sui/activity/activity-nofreelist.html?activityId=" + activityId + "&ask=1";
            String url = "http://m.61park.cn/t/html-sui/activity/activity-nofreelist.html?activityId=" + activityId + "&ask=1";
            wv.loadUrl(url);
        }
    }
