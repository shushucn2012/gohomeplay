...
/**
 * CourseListByCateActivity中用到分类滚动
 */
public class CourseListPagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public CourseListPagerSlidingTabStrip(Context context) {
        this(context, null);
    }

    public CourseListPagerSlidingTabStrip(Context context, AttributeSet attrs) {
