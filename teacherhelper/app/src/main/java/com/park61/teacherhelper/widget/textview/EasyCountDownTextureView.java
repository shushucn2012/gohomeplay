...
public class EasyCountDownTextureView extends TextureView
    ...
    private float thridTranslateX;
    private float  thridTranslateColonX;
   ...
   private   Paint textpain;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        this.timeHour = typedArray.getInteger(R.styleable.EasyCountDownTextureView_easyCountHour,
            0);
        this.timeDay = typedArray.getInteger(R.styleable.EasyCountDownTextureView_easyCountDay,
                0);
        ...
        textpain.setTextSize(UIUtil.dp(context,10));
    }
    ...
    private void updateTime() {
        this.millisInFuture = timeDay * ONE_DAY+this.timeHour * ONE_HOUR + this.timeMinute * ONE_MINUTE +
    ...
    private void refitBackgroundAttribute() {
        ...
        this.thridTranslateX=this.rectWidth*3 + this.rectSpacing*3 + paddingLeft;
        ...
        this.thridTranslateColonX=this.thridTranslateX - this.rectSpacing / 2;
    ...
    public void setTimeDay(final long timeDay) {
        this.timeDay = timeDay;
        this.updateTime();
    }

    public void setTimeHour(final long timeHour) {
        this.timeHour = timeHour;
        this.updateTime();
    }


    public void setTimeMinute(final long timeMinute) {
        this.timeMinute = timeMinute;
        this.updateTime();
    }


    public void setTimeSecond(final long timeSecond) {
    ...
    public void startAndRestoreTime() {
        if (this.pauseTime > 0) {
            ...
            this.pauseTime = 0;
//            if(millisInFuture==0){
//                Toast.makeText(context,"我走完了",Toast.LENGTH_LONG).show();
//            }
        }
        this.start();
    }
    ...
    private class EasyThread extends Thread {
        ...
        private long checkCalendarHour(final long millisInFuture, long calendarHour) {
                        ...
                        synchronized (this) {
                            ...
                            drawTimeAndBackground(canvas,
                                String.format(locale, LESS_THAN_TEN_FORMAT,
                                        this.checkCalendarHour(millisInFuture, timeDay-1)),
//                                    this.checkCalendarHour(millisInFuture, timeHour)),
    ...
    private void drawTimeAndBackground(@NonNull final Canvas canvas,
        ...
        canvas.drawText(day, backgroundRectF.centerX(), timePaintBaseLine, timePaint);
        canvas.restore();

        // colon
        canvas.save();
        canvas.translate(firstTranslateColonX+5, paddingTop);
        canvas.drawText("天", -15, timePaintBaseLineFixed, textpain);
        canvas.restore();
        ...
        // background
        canvas.save();
        canvas.translate(thridTranslateX, paddingTop);
        canvas.drawRoundRect(backgroundRectF, rectRadius, rectRadius, backgroundPaint);
        // border
        this.drawRectBorder(canvas, backgroundRectF, rectRadius, rectBorderPaint);
        ...
        // colon
        canvas.save();
        canvas.translate(thridTranslateColonX, paddingTop);
        canvas.drawText(COLON, 0, timePaintBaseLineFixed, colonPaint);
        canvas.restore();
