...
public class BannerModule extends LinearLayout {

    private BGABanner banner;

    public BannerModule(Context context, List<CmsItem> bannerList) {
        super(context);
        LayoutInflater.from(context).inflate(R.layout.banner_module, this, true);
