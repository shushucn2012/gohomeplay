...
public class MyDownLoadVAdioActivity extends BaseActivity implements ViewPager.OnPageChangeListener {
    ...
    DownloadedVAdioFragment downloadedFragment;
    ...
    public void initData() {
        ...
        downloadedFragment = new DownloadedVAdioFragment();
        ...
        binding.leftTv.setText("已缓存");
        binding.rightTv.setText("缓存中");
    }
