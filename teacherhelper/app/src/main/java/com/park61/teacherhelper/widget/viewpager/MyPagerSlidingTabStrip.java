...
public class MyPagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public MyPagerSlidingTabStrip(Context context, AttributeSet attrs,
        ...
        //tabsContainer.setPadding(DevAttr.dip2px(getContext(), 10), 0, DevAttr.dip2px(getContext(), 10), 0);
        ...
        defaultTabLayoutParams = new LinearLayout.LayoutParams(DevAttr.dip2px(getContext(), 76), LayoutParams.MATCH_PARENT);
    ...
    private void addTab(final int position, View tab, View tab2) {
        ...
        tab.setPadding(tabPadding, DevAttr.dip2px(getContext(), 4), tabPadding, 0);
        ...
        tab2.setPadding(tabPadding, DevAttr.dip2px(getContext(), 4), tabPadding, 0);
		...
		/*LinearLayout.LayoutParams mLayoutParams = new LinearLayout.LayoutParams(
                LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);*/
        LinearLayout.LayoutParams mLayoutParams = new LinearLayout.LayoutParams(DevAttr.dip2px(getContext(), 76), LayoutParams.MATCH_PARENT);
