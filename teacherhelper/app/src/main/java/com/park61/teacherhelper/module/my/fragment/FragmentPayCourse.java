 ...
 * 我的课程-已购买
 */
public class FragmentPayCourse extends BaseFragment {
    ...
    private List<TeacherCourseBean> mList;
    ...
    public void initData() {
        mList = new ArrayList<>();
        adapter = new MyCourseListAdapter(parentActivity, mList);
    ...
    private void asyncGetList() {
        String wholeUrl = AppUrl.host + AppUrl.myCourseBuyList;
    ...
    BaseRequestListener listListener = new JsonRequestListener() {
        ...
        public void onSuccess(int requestId, String url, JSONObject jsonResult) {
            dismissDialog();
            ViewInitTool.listStopLoadView(mPullRefreshListView);
            List<TeacherCourseBean> currentPageList = new ArrayList<>();
            ...
            for (int i = 0; i < actJay.length(); i++) {
                currentPageList.add(gson.fromJson(actJay.optJSONObject(i).toString(), TeacherCourseBean.class));
            }
