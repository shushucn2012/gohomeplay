 ...
 */
public class MyToDoWorkFragment extends BaseFragment {
    ...
    //private ToDoWorkListAdapter adapter;
    private ToDoWorkRvAdapter adapter;
    ...
    public void initView() {
        ...
        //adapter = new ToDoWorkListAdapter(parentActivity, list);
    ...
    public void initData() {
        ...
        list = new ArrayList<>();
        adapter = new ToDoWorkRvAdapter(parentActivity, list);
    ...
    public void initListener() {
        adapter.setOnItemOperateClickListener(new ToDoWorkRvAdapter.OnItemOperateClickListener() {
            @Override
    ...
    private void asyncWorkList() {
        ...
        map.put("status", WorkPlanMainActivity.WorkState.TODO);//状态：0待办，1已完成
