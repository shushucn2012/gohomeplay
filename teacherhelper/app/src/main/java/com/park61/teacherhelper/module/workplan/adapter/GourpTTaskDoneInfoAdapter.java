...
public class GourpTTaskDoneInfoAdapter extends BaseAdapter {

    private Context mContext;
    private List<TaskDoneInfoBean> mlist;
    private OnNoticeClickedListener mOnNoticeClickedListener;

    public GourpTTaskDoneInfoAdapter(Context context, List<TaskDoneInfoBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.group_ttask_doneinfos_item, null);
