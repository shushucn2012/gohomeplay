...
import com.park61.teacherhelper.module.home.adapter.FuWuBDContentListAdapter;
...
public class FuWuBDContentModule extends LinearLayout {

    private ListView lv_show;
    private FuWuBDContentListAdapter mShowListAdapter;

    public FuWuBDContentModule(Context context, List<ContentItem> sList, String moduleName) {
        super(context);
        LayoutInflater.from(context).inflate(R.layout.fuwubd_content_module, this, true);
        ((TextView) findViewById(R.id.tv_teacher_show)).setText(moduleName);
        lv_show = (ListView) findViewById(R.id.lv_show);
        lv_show.setFocusable(false);
        mShowListAdapter = new FuWuBDContentListAdapter(context, sList);
