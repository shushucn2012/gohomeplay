...
public class SubCourseAudioActivity extends AudioBaseActivity {
    ...
    private ImageView img_sc, img_bofang, img_cp, img_icon;
    ...
    private TextView tv_course_titles, tv_titlename, tv_titletime, tv_messagecount, tv_attentcount, tv_title, tv_commentsend, recom_tv_one, recom_tv_two, scan_num;
    ...
    public void setLayout() {
        ...
        setContentView(R.layout.activity_subcourse_audio);
    }
    ...
    public void initView() {
        ...
        circleImageView = (CircleImageView) findViewById(R.id.img_bofang_cover);
        img_bofang = (ImageView) findViewById(R.id.img_bofang_icon);
        ...
        scan_num = (TextView) findViewById(R.id.tv_scannumber);
        img_cp = (ImageView) findViewById(R.id.img_audio_cover);
        img_icon = (ImageView) findViewById(R.id.img_audio_center);
    ...
    public void initData() {
        ...
        fileSourcesAdapter = new FileSourcesAdapter(SubCourseAudioActivity.this, showFList);
    ...
    public void initListener() {
        ...
        img_bofang.setOnClickListener(v -> {
            mPlayerState = aliyunVodPlayer.getPlayerState();
            if (mPlayerState == IAliyunVodPlayer.PlayerState.Started) {
                //如果已经开始，就暂停
                aliyunVodPlayer.pause();
                img_bofang.setImageResource(R.mipmap.gequcaidan);
            } else {
                //其他状态
                aliyunVodPlayer.start();
                img_bofang.setImageResource(R.mipmap.gequzanting);
            }
        });
...
//            collect = 0;
//        }
        ImageManager.getInstance().displayImg(img_cp, subCourseBean.getCoverImg());
        ImageManager.getInstance().displayImg(img_icon, subCourseBean.getCoverImg());
        ImageManager.getInstance().displayImg(circleImageView, subCourseBean.getCoverImg());
...
//        tv_attentcount.setText(curCourseSectionBean.getPraiseNumDsc());
        ...
        scan_num.setText(subCourseBean.getLearningNum() + "人学习");
...
//        asyncGetComment();
    ...
    BaseRequestListener listener = new JsonRequestListener() {
        ...
        public void onSuccess(int requestId, String url, JSONObject jsonResult) {
            ...
            Toast.makeText(SubCourseAudioActivity.this, "已收藏", Toast.LENGTH_LONG).show();
        }
    };
    ...
    BaseRequestListener clistener = new JsonRequestListener() {
        ...
        public void onSuccess(int requestId, String url, JSONObject jsonResult) {
            ...
            img_sc.setImageResource(R.mipmap.content_redrestore);
            sendBroadcast(new Intent().setAction("ACTION_REFRESH_SKLIST"));
            Toast.makeText(SubCourseAudioActivity.this, "已取消收藏", Toast.LENGTH_LONG).show();
        }
    };
